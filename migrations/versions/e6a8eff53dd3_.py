...
Revision ID: e6a8eff53dd3
Revises: 
Create Date: 2020-05-04 17:46:46.856149
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['author_name'], ['author.username'], ),
    sa.PrimaryKeyConstraint('id')
    )
